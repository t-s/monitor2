...
var all = require('./routes/app/all.jsx');
var type = require('./routes/app/type.jsx');
var rack = require('./routes/app/rack.jsx');
var worker = require('./routes/app/worker.jsx');
...
module.exports = (
  <Route handler={ReactRouter.RouteHandler}>
    ...
    <Route path='/app/all' handler={all} />
    <Route path='/app/type' handler={type} />
    <Route path='/app/rack' handler={rack} />
    <Route path='/app/worker' handler={worker} />
